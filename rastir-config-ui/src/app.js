...
const API_BASE_URL = window.RASTIR_API_URL || 'http://localhost:8080';
...
function populateForm(config) {
    ...
    document.getElementById('evaluation-judge-model').value = config.evaluation.judge_model || 'gpt-4o-mini';
    document.getElementById('evaluation-judge-provider').value = config.evaluation.judge_provider || 'openai';
...
function updateSourceBadges() {
    const ids = [
        ...
        'evaluation-judge-model', 'evaluation-judge-provider',
...
function buildConfig() {
    return {
        ...
        evaluation: {
            ...
            judge_model:   document.getElementById('evaluation-judge-model').value.trim(),
            judge_provider: document.getElementById('evaluation-judge-provider').value,
        },
        rate_limit: {
